...
\textsc{\large 经济统计学}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 2019年世界各国人口数据展示}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 经济统计学17}\\[0.5cm] % Minor heading such as course title
